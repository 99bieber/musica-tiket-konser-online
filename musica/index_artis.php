                    ...
                    <div class="classy-nav-container breakpoint-off">
                        <div class="container-fluid">
                            ...
                            <nav class="classy-navbar justify-content-between" id="musicaNav" >
                                <!-- Nav brand -->
                                <a href="index_artis.php?page=home" class="nav-brand"><img src="img/logo.png" alt=""></a>
                                <!-- Navbar Toggler -->
                                ...
                                <div class="classy-menu" style="overflow: hidden;">
                                    ...
                                    <div class="classynav">
                                        <ul>
                                            <li><a href="index_artis.php?page=home">Home</a></li>
                                            <li><a href="index_artis.php?page=artis&nama_artis=">Artis</a></li>
                                            <?php if ($d['level']==1) {?>
                                                 <li><a href="index_artis.php?page=upload">Upload Konser</a></li>
                                                 <li><a href="index_artis.php?page=transaksi"><i class="fas fa-handshake"></i></a></li>
                                            <?php } ?>
                                            <li><a href="index_artis.php?page=chart"><i class="fas fa-shopping-cart"></i></a></li>
                                            <li><a href="" data-toggle="modal" data-target="#myModal" ><img class="image-cropper profile-pic" src="proses/images/profile/<?php echo $d['foto'];?>"> </a></li>
